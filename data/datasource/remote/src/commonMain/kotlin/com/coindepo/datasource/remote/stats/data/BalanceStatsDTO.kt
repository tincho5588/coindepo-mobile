...
data class BalanceDTO(
    ...
    @SerialName("freezed_trx_balance_currency") val freezedTrxBalanceCurrency: BigNum? = null,
    @SerialName("in_transit") val inTransit: BigNum,
    @SerialName("in_transit_currency") val inTransitCurrency: BigNum? = null,
    @SerialName("interest") val interest: BigNum,
    @SerialName("interest_currency") val interestCurrency: BigNum,
    @SerialName("interest_currency_currency") val interestCurrencyCurrency: BigNum? = null,
    @SerialName("is_token") val isToken: Int,
    @SerialName("new_trx_balance") val newTrxBalance: BigNum,
    @SerialName("new_trx_balance_currency") val newTrxBalanceCurrency: BigNum? = null,
    @SerialName("order") val order: Int,
    @SerialName("pending_trx_balance") val pendingTrxBalance: BigNum,
    @SerialName("pending_trx_balance_currency") val pendingTrxBalanceCurrency: BigNum? = null,
    @SerialName("precision") val precision: Int,
    @SerialName("processing_trx_balance") val processingTrxBalance: BigNum,
    @SerialName("processing_trx_balance_currency") val processingTrxBalanceCurrency: BigNum? = null,
    @SerialName("queued_trx_balance") val queuedTrxBalance: BigNum,
    @SerialName("queued_trx_balance_currency") val queuedTrxBalanceCurrency: BigNum? = null,
