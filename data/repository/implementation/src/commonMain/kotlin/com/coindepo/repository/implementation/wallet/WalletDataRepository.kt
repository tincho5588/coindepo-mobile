...
package com.coindepo.repository.implementation.wallet
...
class WalletDataRepositoryImpl(
    private val remoteWalletDataSource: RemoteWalletDataSource
) : WalletDataRepository {
    override suspend fun getWalletData(
        coin: String,
        userName: String,
        clientToken: String
    ): OperationResult = remoteWalletDataSource.getWalletData(coin, userName, clientToken).fold(
        onSuccess = {
